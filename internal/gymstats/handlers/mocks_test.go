...
func (m *MockexercisesRepo) Add(ctx context.Context, exercise repo.Exercise) (*repo.Exercise, error) {
	m.ctrl.T.Helper()
...
func (m *MockexercisesRepo) ExercisesCount(ctx context.Context, params repo.ListParams) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockexercisesRepo) Get(ctx context.Context, id int) (*repo.Exercise, error) {
	m.ctrl.T.Helper()
...
func (m *MockexercisesRepo) List(ctx context.Context, params repo.ListParams) ([]repo.Exercise, int, error) {
	m.ctrl.T.Helper()
...
func (m *MockexercisesRepo) Update(ctx context.Context, exercise *repo.Exercise) error {
	m.ctrl.T.Helper()
