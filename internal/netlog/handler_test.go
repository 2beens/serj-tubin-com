...
func TestNewNetlogHandler(t *testing.T) {
	...
	handler := NewHandler(router, netlogApi, metrics, "", nil)
...
func TestNetlogHandler_handleGetAll_Empty(t *testing.T) {
	...
	r := mux.NewRouter()
	metrics := metrics.NewTestManager()
	handler := NewHandler(r, netlogApi, metrics, browserReqSecret, loginChecker)
	require.NotNil(t, handler)
	require.NotNil(t, r)
...
func TestNetlogHandler_handleGetAll_Unauthorized(t *testing.T) {
	...
	metrics := metrics.NewTestManager()
	handler := NewHandler(netlogRouter, netlogApi, metrics, browserReqSecret, loginChecker)
	require.NotNil(t, handler)
	require.NotNil(t, r)
