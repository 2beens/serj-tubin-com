...
ARG SERJ_TUBIN_COM_SPOTIFY_CLIENT_ID
ARG SERJ_TUBIN_COM_SPOTIFY_CLIENT_SECRET
ARG SERJ_TUBIN_COM_SPOTIFY_AUTH_TOKEN
...
ENV SERJ_TUBIN_COM_SPOTIFY_CLIENT_ID=${SERJ_TUBIN_COM_SPOTIFY_CLIENT_ID}
ENV SERJ_TUBIN_COM_SPOTIFY_CLIENT_SECRET=${SERJ_TUBIN_COM_SPOTIFY_CLIENT_SECRET}
ENV SERJ_TUBIN_COM_SPOTIFY_AUTH_TOKEN=${SERJ_TUBIN_COM_SPOTIFY_AUTH_TOKEN}
